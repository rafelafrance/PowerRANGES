...
#             [Trait(value=[8, 5], units="mm", units_inferred=False, start=0, end=15)],
#         )
#
#     def test_parse_02(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("testes: 20mm. Sent to Berkeley 10/1/71"),
#             [Trait(value=20, units="mm", units_inferred=False, start=0, end=12)],
#         )
#
#     def test_parse_03(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("ear from notch=19 mm; reproductive
#             data=testis 5mm ; "),
#             [Trait(value=5, units="mm", units_inferred=False, start=22, end=50)],
#         )
#
#     def test_parse_04(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("adult ; reproductive data=NS; T=9x4 ; endoparasite "),
#             [Trait(value=[9, 4], units=None, units_inferred=True, start=8, end=35)],
#         )
#
#     def test_parse_05(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("2.3 g; reproductive data=testes: 18x8 mm; scrotal ;"),
#             [Trait(value=[18, 8], units="mm", units_inferred=False, start=7, end=40)],
#         )
#
#     def test_parse_06(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("Plus Tissue; plus Baculum: Test 21x11"),
#             [Trait(value=[21, 11], units=None, units_inferred=True, start=27,
#             end=37)],
#         )
#
#     def test_parse_07(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("; reproductive data=testes scrotal; T =
#             9mm in length"),
#             [Trait(value=9, units="mm", units_inferred=False, start=2, end=43)],
#         )
#
...
#         self.assertEqual(
#             TESTES_SIZE.parse("reproductive data=testes abdominal; T = 3 x 1.8 ;"),
#             [Trait(value=[3, 1.8], units=None, units_inferred=True, start=0, end=47)],
#         )
#
#     def test_parse_10(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("testis-20mm ; reproductive data=testis-21mm ; "),
#             [
#                 Trait(value=20, units="mm", units_inferred=False, start=0, end=11),
#                 Trait(value=21, units="mm", units_inferred=False, start=14, end=43),
#             ],
#         )
#
...
#             [Trait(value=6, units=None, units_inferred=True, start=0, end=9)],
#         )
#
#     def test_parse_12(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("testes scrotal, L testis 13x5mm"),
#             [Trait(value=[13, 5], units="mm", units_inferred=False, start=18,
#             end=31)],
#         )
#
#     def test_parse_13(self):
#         self.assertEqual(
#             TESTES_SIZE.parse('"gonad length 1":"3.0", "gonad length 2":"2.0",'),
#             [
#                 Trait(
#                     value=3,
#                     units=None,
...
#             [Trait(value=7, units="mm", units_inferred=False, start=0, end=10)],
#         )
#
#     def test_parse_18(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("reproductive data=T=10x4 ; "),
#             [Trait(value=[10, 4], units=None, units_inferred=True, start=0, end=24)],
#         )
#
...
#             [Trait(value=[5, 3.5], units="MM", units_inferred=False, start=0,
#             end=15)],
#         )
#
...
#             [Trait(value=[5, 3], units=None, units_inferred=True, start=2, end=23)],
#         )
#
...
#         self.assertEqual(
#             TESTES_SIZE.parse("; reproductive data=TESTES NOT DESCENDED - 6 MM age"),
#             [Trait(value=6, units="MM", units_inferred=False, start=2, end=47)],
#         )
#
#     def test_parse_30(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("A. Svihla ; verbatim collector=Dept. No. 2025, W. "),
#             []
#         )
#
...
#             [Trait(value=[32, 11], units=None, units_inferred=True, start=2, end=41)],
#         )
#
#     def test_parse_33(self):
#         self.assertEqual(
#             TESTES_SIZE.parse("; reproductive data=R 20mm L x 6 mm Wne scars ;"),
#             [
#                 Trait(
#                     value=20,
#                     units="mm",
...
#                 ),
#                 Trait(
#                     value=6, units="mm", units_inferred=False, side="l", start=2,
#                     end=33
#                 ),
#             ],
#         )
...
#         self.assertEqual(TESTES_SIZE.parse("; reproductive data=t=233mg ;"), [])
#
