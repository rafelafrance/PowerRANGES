...
class TestBodyMass(unittest.TestCase):
    ...
    def test_body_mass_02(self):
        ...
        self.assertEqual(
            ...
            [BodyMass(trait="body_mass", mass=20, start=0, end=14)],
        )
    ...
    def test_body_mass_06(self):
        ...
        self.assertEqual(
            parse('"weight":"94 gr."'),
            [BodyMass(trait="body_mass", mass=94, start=1, end=15)],
        )
    ...
    def test_body_mass_07(self):
        ...
        self.assertEqual(
            ...
            [BodyMass(trait="body_mass", mass=20.2, ambiguous=True, start=14, end=22)],
        )
    ...
    def test_body_mass_08(self):
        ...
        self.assertEqual(
            parse("Body: 15 g"),
            [BodyMass(trait="body_mass", mass=15, start=0, end=10)],
        )
    ...
    def test_body_mass_09(self):
        ...
        self.assertEqual(
            ...
            [BodyMass(trait="body_mass", mass=20.1, start=3, end=21)],
        )
    ...
    def test_body_mass_10(self):
        ...
        self.assertEqual(
            ...
            [BodyMass(trait="body_mass", mass=1192, start=1, end=18)],
        )
    ...
    def test_body_mass_11(self):
        ...
        self.assertEqual(
            ...
            [
                BodyMass(
                    trait="body_mass", mass=1192, units_inferred=True, start=1, end=17
                )
            ],
        )
    ...
    def test_body_mass_12(self):
        ...
        self.assertEqual(
            ...
            [BodyMass(trait="body_mass", mass=[20.5, 31.8], start=1, end=21)],
        )
    ...
    def test_body_mass_14(self):
        ...
        self.assertEqual(
            parse("Body: 1.2 kg"),
            [BodyMass(trait="body_mass", mass=1200, start=0, end=12)],
        )
    ...
    def test_body_mass_16(self):
        ...
        self.assertEqual(
            parse("body mass=0 g"),
            [BodyMass(trait="body_mass", mass=0, start=0, end=13)],
        )
    ...
    def test_body_mass_17(self):
        ...
        self.assertEqual(
            parse("wt=10 g"),
            [BodyMass(trait="body_mass", mass=10, start=0, end=7)],
        )
    ...
    def test_body_mass_18(self):
        ...
        self.assertEqual(
            parse("weight=.65 kg;"),
            [BodyMass(trait="body_mass", mass=650, start=0, end=13)],
        )
