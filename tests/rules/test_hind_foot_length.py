...
class TestHindFootLength(unittest.TestCase):
    def test_hind_foot_length_01(self) -> None:
    ...
    def test_hind_foot_length_02(self) -> None:
    ...
    def test_hind_foot_length_03(self) -> None:
    ...
    def test_hind_foot_length_04(self) -> None:
    ...
    def test_hind_foot_length_05(self) -> None:
